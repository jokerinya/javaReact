...
public class ROIExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(ROIDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new ROIStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static ROIDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static ROIDateTimeConverter dateTimeConverter = new ROIStandardDateTimeConverter();

    public ROIExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public ROIExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new ROIMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=ROIHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,ROIExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=ROIHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
