...
public class ROIKPSPublicSoap
{
    ...
    public ROIKPSPublicSoap(){}

    public ROIKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public ROIKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        ROIExtendedSoapSerializationEnvelope envelope= new ROIExtendedSoapSerializationEnvelope(ROIExtendedSoapSerializationEnvelope.VER11);
