   ...
   * Add-Update sample obj
{
  ...
  add(userId, socialMediaAddresses){
    return axios.post(
        `${process.env.REACT_APP_BACKEND_API_URL}/socialMediaAddress/${userId}/add`, socialMediaAddresses);
  }
  update(userId, socialMediaAddresses){
    return axios.put(
        `${process.env.REACT_APP_BACKEND_API_URL}/socialMediaAddress/${userId}/update`, socialMediaAddresses);
  }
  delete(userId){
    return axios.delete(
